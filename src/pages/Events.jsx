...
const Events = () => {
  ...
  const copy = isEnglish
    ...
    : {
        ...
        noOpen: 'Nenhum evento com inscricao aberta ainda.',
        kicker: 'Eventos',
        title: 'Cada evento gera pontos e movimenta o ranking.',
        description:
          'Proximos, passados e em planejamento. Todos os cards ficam no mesmo tamanho para facilitar a visualizacao.',
        agenda: 'Agenda',
