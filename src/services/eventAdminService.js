...
const normalizePayload = (payload = {}) => ({
  ...
  organizerName: (payload.organizerName || '').toString().trim() || null,
  ...
  eventSocialEmail: (payload.eventSocialEmail || payload.supportEmail || payload.organizerEmail || '').toString().trim() || null,
  prizesDescription: (payload.prizesDescription || '').toString().trim() || null,
  mapIframeUrl: (payload.mapIframeUrl || '').toString().trim() || null,
