...
const startAnchor = "const athleteCommunityRows = useMemo(() => {";
const endAnchor = "export default Ranking;";

const startIndex = content.indexOf(startAnchor);
const endIndex = content.lastIndexOf(endAnchor);
                                ...
                                >
                                    ...
                                    <div className="ajp-category-info">
                                        ...
                                        <div className="ajp-category-country">
                                            ...
                                            <span>{countryLabelFromAthlete(athlete)}</span>
                                        </div>
                                    </div>
                                    <div className="ajp-category-stats">
                                        ...
                                        <div className="ajp-stat-col">
                                            ...
                                            <span className="ajp-stat-label" style={{fontSize: '12px'}}>🏆</span>
                                        </div>
                                        <div className="ajp-stat-col">
    ...
    return (
        <div className="ajp-page-container">
            ...
            <div className="ajp-category-grid">
                {groupedAthletes.map(renderCategoryCard)}
            </div>
        </div>
    );
};
...
console.log("Ranking.jsx replacement completed.");
