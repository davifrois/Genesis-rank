...
const anchorStr = 'className={`ranking-minimal ranking-ajp ranking-clean ranking-reference-v2 ranking-v2-page';
const anchorIndex = content.indexOf(anchorStr);
...
const startIndex = content.lastIndexOf(returnStartStr, anchorIndex);

const returnEndStr = 'export default Ranking;';
const endIndex = content.lastIndexOf(returnEndStr);
...
console.log("Ranking.jsx return block replaced safely.");
